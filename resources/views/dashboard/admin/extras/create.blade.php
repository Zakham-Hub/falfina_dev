                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="type" id="type" class="form-select" required>
                                <option value="addon">اضافه</option>
                                <option value="sauce">صوص</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="p-3 mb-3 text-center border rounded">
                                ...
                                <div class="mt-2">
                                        <img id="extraPreview" src="" alt="" width="100" style="cursor: pointer;" onclick="openImageModal(this.src, 'الصوره')">
                                    </div>
                            </div>
                        </div>
                    </div>
