...
class AuthController extends Controller
{
    ...
    public function __construct(
        MultiAuthService $authService,
        \App\Services\WhatsAppOtpService $otpService,
    ) {
    ...
    public function getLoyaltyPoints()
    {
        ...
        return $this->successResponse($data, "Successfully retrieved loyalty points");
    }
    ...
    public function me(Request $request)
    {
        ...
        return $this->successResponse(
            $resource,
            "$type profile retrieved successfully",
        );
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            $refreshToken = JWTAuth::claims(["refresh" => true])->fromUser(
                $user,
            );
            $user->load("profile");
            return $this->successResponse(
